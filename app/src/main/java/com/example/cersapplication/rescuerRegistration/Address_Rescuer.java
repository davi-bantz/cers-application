...
public class Address_Rescuer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Address_Rescuer.this, "You can Register Now", Toast.LENGTH_SHORT).show();
        ...
        victimNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(textPurok)) {
                    Toast.makeText(Address_Rescuer.this, "Please enter your Purok/House No.", Toast.LENGTH_LONG).show();
                    editPurok.setError("Purok/House No. is Required");
                    editPurok.requestFocus();
                } else if (radioGroupGender.getCheckedRadioButtonId() == -1) {
                    Toast.makeText(Address_Rescuer.this, "Please Select your Gender", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(Address_Rescuer.this, "Please enter your Barangay", Toast.LENGTH_LONG).show();
                    editBarangay.setError("Barangay is Required");
                    editBarangay.requestFocus();
                } else if (TextUtils.isEmpty(textStreet)) {
                    Toast.makeText(Address_Rescuer.this, "Please enter your Street", Toast.LENGTH_LONG).show();
                    editStreet.setError("Street is Required");
                    editStreet.requestFocus();
                } else if (TextUtils.isEmpty(textCity)) {
                    Toast.makeText(Address_Rescuer.this, "Please enter your City/Municiaplity", Toast.LENGTH_LONG).show();
                    editCity.setError("City/Municipality is Required");
                    editCity.requestFocus();
                } else if (TextUtils.isEmpty(textProvince)) {
                    Toast.makeText(Address_Rescuer.this, "Please enter your Province", Toast.LENGTH_LONG).show();
                    editProvince.setError("Province is Required");
                    editProvince.requestFocus();
                } else if (TextUtils.isEmpty(textCivilStatus)) {
                    Toast.makeText(Address_Rescuer.this, "Please enter your Civil Status", Toast.LENGTH_LONG).show();
                    editCivilStatus.setError("Civil Status is Required");
                    editCivilStatus.requestFocus();
                } else if (TextUtils.isEmpty(textBloodType)) {
                    Toast.makeText(Address_Rescuer.this, "Please enter your Blood Type", Toast.LENGTH_LONG).show();
                    ...
                    registerUser(textPurok, textBarangay, textStreet, textCity, textProvince);
        ...
        victimBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Address_Rescuer.this, create_accountCitizen.class);
    ...
    private void registerUser(String textPurok, String textBarangay, String textStreet, String textCity, String textProvince) {
        ...
        ReadWriteAdressDetails writeAddressDetails = new ReadWriteAdressDetails(textPurok, textStreet, textBarangay, textCity, textProvince);

        //database Reference
        final DatabaseReference basicDetails = FirebaseDatabase.getInstance().getReference("Rescuers").child(firebaseUser.getUid()).child("Address");

        basicDetails.child(firebaseUser.getUid()).setValue(writeAddressDetails);
    ...
    private void ExtraDetails(String textGender, String textBloodType, String textCivilStatus) {
        ...
        final DatabaseReference basicDetails = FirebaseDatabase.getInstance().getReference("Citizens").child(firebaseUser.getUid());
        ...
        basicDetails.child(firebaseUser.getUid()).setValue(writeExtraDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Intent intent = new Intent(Address_Rescuer.this, ServiceProfile.class);
