...
import com.example.cersapplication.rescuerProfile.UpdateInfoRescuer.update_rescuer_address;
...
public class Rescuer_Address extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rescuer_address);
        ...
        buttonbacktosettings.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent backtoSettings = new Intent(Rescuer_Address.this, RescuerSettings.class);
        ...
        addressupdate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gotoUpdate = new Intent(Rescuer_Address.this, update_rescuer_address.class);
        ...
        if(CitizenAddress !=null){
            Toast.makeText(Rescuer_Address.this, "Something is wrong. User details are not available at the moment!",
    ...
    private void showCitizenAddressProfile(FirebaseUser CitizenAddress) {
        ...
        DatabaseReference referenceCitizen = FirebaseDatabase.getInstance().getReference("Rescuers").child("Address");
        referenceCitizen.child(getUserId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Rescuer_Address.this, "Something went wrong!",
                        Toast.LENGTH_LONG).show();
                progressBarAddressCitizen.setVisibility(View.GONE);
