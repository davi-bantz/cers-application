...
public class update_address extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //layout declaration
        updatepurok = findViewById(R.id.Edit_Citizen_Purok);
        updateStreet = findViewById(R.id.Edit_Citizen_Street);
        updateBarangay = findViewById(R.id.Edit_Citizen_Barangay);
        updateCity = findViewById(R.id.Edit_Citizen_City);
        updateProvince = findViewById(R.id.Edit_Citizen_Province);
        progressBar_addressProg = findViewById(R.id.progressBar_UpdateADD);
        ...
        backtoaddressProf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent backtoUserAddress = new Intent(update_address.this, Citizen_Address.class);
        ...
        Button updateADDDetails = findViewById(R.id.Update_AddBtn);
    ...
    private void updateaddress(FirebaseUser current_address) {
        ...
        if (TextUtils.isEmpty(purok)) {
            Toast.makeText(update_address.this, "Please enter your Purok/House No.", Toast.LENGTH_LONG).show();
            updatepurok.setError("Purok/House No. is Required");
            updatepurok.requestFocus();
        } else if (TextUtils.isEmpty(barangay)) {
            Toast.makeText(update_address.this, "Please enter your Barangay", Toast.LENGTH_LONG).show();
            updateBarangay.setError("Barangay is Required");
            updateBarangay.requestFocus();
        } else if (TextUtils.isEmpty(street)) {
            Toast.makeText(update_address.this, "Please enter your Street", Toast.LENGTH_LONG).show();
            updateStreet.setError("Street is Required");
            updateStreet.requestFocus();
        } else if (TextUtils.isEmpty(city)) {
            Toast.makeText(update_address.this, "Please enter your City/Municiaplity", Toast.LENGTH_LONG).show();
            updateCity.setError("City/Municipality is Required");
            updateCity.requestFocus();
        } else if (TextUtils.isEmpty(province)) {
            Toast.makeText(update_address.this, "Please enter your Province", Toast.LENGTH_LONG).show();
            ...
            referenceuser.child(userAddressID).child("Address").setValue(updateaddress).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(update_address.this, "Update Succesfull!", Toast.LENGTH_LONG).show();
                        Intent goCitBD = new Intent(update_address.this, Citizen_Address.class);
                        ...
                        try{
                            ...
                            Toast.makeText(update_address.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
        ...
        referenceprofile.child(UserID).child("Address").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (citizenaddress != null){
                    ...
                    Toast.makeText(update_address.this, "Something went wrong!", Toast.LENGTH_LONG).show();
                }
                progressBar_addressProg.setVisibility(View.GONE);
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_refresh){
            ...
            //change pass
            Intent changeP = new Intent(update_address.this, UpdatePassword.class);
            startActivity(changeP);
            finish();
        }else if (id == R.id.menu_Delete_Account){
            //delete acc
            Intent deleteAcc = new Intent(update_address.this, DeleteAccount.class);
            startActivity(deleteAcc);
            finish();
        }else if(id == R.id.menu_log_out){
            //log out
            authprofile.signOut();
            Toast.makeText(update_address.this, "You have logged out",
                    Toast.LENGTH_LONG).show();
            Intent gobackMain = new Intent(update_address.this, MainActivity.class);
            gobackMain.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK
                    | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(gobackMain);
            finish();
        } else {
            Toast.makeText(update_address.this, "Something went wrong",
                    Toast.LENGTH_LONG).show();
