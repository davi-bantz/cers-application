...
public class Update_Basic_Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_basic_details);
        ...
        backtoUserProf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent backtoUserProfile = new Intent(Update_Basic_Details.this, CitizenBasicDetails.class);
        ...
        updateBoD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //datepicker dialog
                birthdatepicker = new DatePickerDialog(Update_Basic_Details.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        updateEmail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gotoEditEmail = new Intent(Update_Basic_Details.this, Update_Email.class);
    ...
    private void updatedetails(FirebaseUser currentaccount) {
        ...
        if (TextUtils.isEmpty(fullname)) {
            Toast.makeText(Update_Basic_Details.this, "Please enter your Full Name", Toast.LENGTH_LONG).show();
            updateName.setError("Full Name is Required");
            updateName.requestFocus();
        } else if (TextUtils.isEmpty(Bod)) {
            Toast.makeText(Update_Basic_Details.this, "Please enter your Birthdate", Toast.LENGTH_LONG).show();
            updateBoD.setError("Date of Birth is Required");
            updateBoD.requestFocus();
        } else if (TextUtils.isEmpty(phonenumber)) {
            Toast.makeText(Update_Basic_Details.this, "Please enter your Phone Number", Toast.LENGTH_LONG).show();
            updatephonenumber.setError("Phone Number is Required");
            updatephonenumber.requestFocus();
        } else if (phonenumber.length() != 11) {
            Toast.makeText(Update_Basic_Details.this, "Please re-enter your Phone Number", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(Update_Basic_Details.this, "Please enter your Username", Toast.LENGTH_LONG).show();
            updateUsername.setError("Username is Required");
            updateUsername.requestFocus();
        } else if (TextUtils.isEmpty(civilstatus)) {
            Toast.makeText(Update_Basic_Details.this, "Please enter your Civil Status", Toast.LENGTH_LONG).show();
            updatecivilStatus.setError("Civil Status is Required");
            updatecivilStatus.requestFocus();
        } else if (TextUtils.isEmpty(bloodtype)) {
            Toast.makeText(Update_Basic_Details.this, "Please enter your Blood Type", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(Update_Basic_Details.this, "Please Select your Gender", Toast.LENGTH_LONG).show();
            ...
            referenceUser.child(UserID).setValue(newUserDetails).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(Update_Basic_Details.this, "Update Succesfull!", Toast.LENGTH_LONG).show();
                            Intent goCitBD = new Intent(Update_Basic_Details.this, CitizenBasicDetails.class);
                        ...
                        try{
                            ...
                            Toast.makeText(Update_Basic_Details.this, e.getMessage(), Toast.LENGTH_LONG).show();
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (readbasicdetails != null) {
                    ...
                    if (readextradetails != null) {
                        ...
                        Toast.makeText(Update_Basic_Details.this, "Something went wrong!", Toast.LENGTH_LONG).show();
                    }
                    progressBar_updatebasicdetails.setVisibility(View.GONE);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_refresh){
            ...
            //change pass
            Intent changeP = new Intent(Update_Basic_Details.this, UpdatePassword.class);
            startActivity(changeP);
            finish();
        }else if (id == R.id.menu_Delete_Account){
            //delete acc
            Intent deleteAcc = new Intent(Update_Basic_Details.this, DeleteAccount.class);
            startActivity(deleteAcc);
            finish();
        }else if(id == R.id.menu_log_out){
            //log out
            authprofile.signOut();
            Toast.makeText(Update_Basic_Details.this, "You have logged out",
                    Toast.LENGTH_LONG).show();
            Intent gobackMain = new Intent(Update_Basic_Details.this, MainActivity.class);
            gobackMain.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_CLEAR_TASK
                    | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(gobackMain);
            finish();
        } else {
            Toast.makeText(Update_Basic_Details.this, "Something went wrong",
                    Toast.LENGTH_LONG).show();
